...
var _user$project$Conspiracies$createErrorMessage = function (httpError) {
	var _p0 = httpError;
	switch (_p0.ctor) {
		case 'BadUrl':
			return _p0._0;
							...
							},
							{
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Conspiracies$viewSummaries, model.summaries)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Conspiracies$main = _elm_lang$html$Html$program(
	{
