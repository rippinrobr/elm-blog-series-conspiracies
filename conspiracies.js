...
var _user$project$Conspiracies$update = F2(
	function (msg, model) {
		return _elm_lang$core$Native_Utils.eq(msg.operation, 'SELECT_TAG') ? _elm_lang$core$Native_Utils.update(
			model,
			{selectedTag: msg.data}) : model;
	});
var _user$project$Conspiracies$initialModel = {
	tags: {
		ctor: '::',
		_0: 'All',
		_1: {
				...
				_0: _elm_lang$html$Html_Attributes$classList(
					{
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'selected',
								_1: _elm_lang$core$Native_Utils.eq(selectedTag, tag)
							},
							_1: {ctor: '[]'}
						}
					}),
...
var _user$project$Conspiracies$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
							...
							},
							{
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: _elm_lang$html$Html$text(
													A2(_elm_lang$core$Basics_ops['++'], model.selectedTag, ' Conspiracies')),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$div,
										{ctor: '[]'},
										A2(_elm_lang$core$List$map, _user$project$Conspiracies$viewSummaries, model.summaryPlaceholders)),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
...
var _user$project$Conspiracies$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Conspiracies$initialModel, view: _user$project$Conspiracies$view, update: _user$project$Conspiracies$update})();

var Elm = {};
Elm['Conspiracies'] = Elm['Conspiracies'] || {};
if (typeof _user$project$Conspiracies$main !== 'undefined') {
    _user$project$Conspiracies$main(Elm['Conspiracies'], 'Conspiracies', undefined);
}
